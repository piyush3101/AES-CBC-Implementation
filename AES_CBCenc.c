/*
This is AES CBC Implementation using the previous ECB Implementation by making minor changes in the previous code
*/
#include<stdio.h>
#include<string.h>
...
int main()
{
	...
	unsigned char key[16]="piyushpushkar123";
	unsigned char iv[16]="password1234abcd";
